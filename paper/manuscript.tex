...
We conclude that Gaia DR3 4277855016732107520 is a promising
dormant BH candidate under the Gaia DR3 NSS modelling assumptions;
...
\item ROSAT non-detection implies an order-of-magnitude X-ray
  upper limit of
  $\log L_X \lesssim 30.7$\,erg\,s$^{-1}$, while VLASS and RACS
