...
merits high-priority multi-epoch radial-velocity follow-up;
independent spectroscopic confirmation is required before any BH
...
with a single evolved star plus a dark (non-luminous) companion.
...
$L_\star = 22\,\Lsun$ are consistent with an evolved star of
...
dormant black hole candidate} that merits high-priority multi-epoch
...
the orbital solution is purely astrometric with no independent RV
data, the companion mass remains contingent on the Gaia pipeline
